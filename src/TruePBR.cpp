...
void TruePBR::DrawSettings()
{
	if (ImGui::TreeNodeEx("PBR", ImGuiTreeNodeFlags_DefaultOpen)) {
		...
		ImGui::SliderFloat("Light Color Contribution", &settings.lightColorContribution, 1e-3f, 3.1415926f, "%.3f");
...
void TruePBR::LoadSettings(json& o_json)
{
	...
	if (o_json["Light Color Contribution"].is_number_float()) {
		settings.lightColorContribution = o_json["Light Color Contribution"];
	}
...
void TruePBR::SaveSettings(json& o_json)
{
	...
	o_json["Light Color Contribution"] = settings.lightColorContribution;
